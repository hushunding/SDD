...
export const ProjectSchmetic: ProjectParamSchemtic = {
    ...
    Proj_MinVehicleLength: {
        ...
        Scole: { type: 'number', min: 0, max: 10000, step: 0.001 },
        Default: 28
    },
    Proj_MinHook2Roller: {
    ...
    Proj_IAtpCommMode: {
        ...
        Scole: { type: 'text', valueset: new Set<string>(['Type_Beacon', 'Type_Loop', 'Type_Both']) },
        Default: 'Type_Beacon'
    },
    Proj_ReverseTractCmd: {
        ...
        Scole: { type: 'text', valueset: new Set<string>(['false', 'true']) },
        Default: 'true'
    },
};
